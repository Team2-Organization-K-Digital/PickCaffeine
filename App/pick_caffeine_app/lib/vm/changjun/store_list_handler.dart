  ...
  Future<void> fetchStore() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        final List<Stores> returnResult = results.map((data) {
        ...
        print('서버 에러 발생: ${res.statusCode}');
        print('응답 내용: ${res.body}');
        Get.snackbar("서버 오류", "매장 정보를 불러오는 데 실패했습니다.");
      }
    } catch (e, stack) {
      print('Error fetching store: $e');
      print(stack);
      Get.snackbar("오류", "매장 정보를 불러오는 중 오류가 발생했습니다.");
    } finally {
