            ...
            children: [
              SingleChildScrollView(
                ...
                child: Row(
                  ...
                  SizedBox(width: 10,),
                    ButtonLightBrown(text: '시간대 별 매출', 
                    onPressed: () {
                  ...
                  title: ChartTitle(
                    ...
                    series: [
                      LineSeries<ChartData, int>(
                        ...
                        xValueMapper: (ChartData date, _) => int.parse(date.date), 
