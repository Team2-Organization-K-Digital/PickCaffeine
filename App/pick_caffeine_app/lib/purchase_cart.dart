...
import 'package:pick_caffein/view/menu_slidable.dart';
...
class CustomerPurchasePage extends StatelessWidget {
          ...
          children: [
            ...
            Obx(() => Container(
              ...
              child: DropdownButtonFormField<String>(
                ...
                value: controller.requestOptions.contains(controller.tempSelectedRequest.value)
                    ? controller.tempSelectedRequest.value
                    : null,
                items: controller.requestOptions
            ...
            // 적용 버튼
            Obx(() => controller.tempSelectedRequest.isNotEmpty
                ? Padding(
                    padding: const EdgeInsets.only(top: 16.0),
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text('요청사항 적용하기', style: TextStyle(fontSize: 16)),
                      ),
                    ),
                  )
                : SizedBox.shrink()),
            ...
            // 적용된 요청사항 표시
            Obx(() => controller.selectedRequest.isNotEmpty
                ? Padding(
                    padding: const EdgeInsets.only(top: 16.0),
                    child: Container(
                      width: double.infinity,
  ...
  Widget _buildCartItemsList() {
    ...
    return Column(
      children: controller.cartItems.asMap().entries.map((entry) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text('단가: ${item.menuPrice.toString().replaceAllMapped(RegExp(r'(\d)(?=(\d{3})+(?!\d))'), (match) => '${match[1]},')}원'),
                    ...
                    Text(
                      ...
                      style: TextStyle(fontWeight: FontWeight.bold, color: Colors.brown[600]),
                    ),
                  ],
                ),
              ),
      ...
      child: Column(
        children: [
          ...
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              onPressed: controller.isLoading.value ? null : controller.saveOrderToDatabase,
              style: ElevatedButton.styleFrom(
